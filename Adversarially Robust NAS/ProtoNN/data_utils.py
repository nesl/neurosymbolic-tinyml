...
def import_auritus_activity_dataset(dataset_folder = 'Train_Val_test/', use_timestamp=False, shuffle=True, window_size = 550, stride = 50, return_test_set = True, return_val_set = True, test_set_size = 300,channels=0):
    ...
    if(return_test_set==True):
        return X_tr, Y_tr, X_test, Y_test, X_val,Y_val
    else:
