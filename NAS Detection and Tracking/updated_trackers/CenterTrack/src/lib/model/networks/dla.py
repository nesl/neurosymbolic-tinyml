...
class DLAUp(nn.Module):
    ...
    def forward(self, layers):
        ...
        #print(len(layers) - self.startp - 1)
...
class DLASeg(BaseModel):
    def __init__(self, num_layers, heads, head_convs, actual_num_stacks, kernel_size, activations, head_conv_value, opt):
        super(DLASeg, self).__init__(
            heads, head_convs, 1, 64 if num_layers == 34 else 128, actual_num_stacks, kernel_size, activations, head_conv_value, opt=opt)
        down_ratio=4
        self.opt = opt
    ...
    def imgpre2feats(self, x, pre_img=None, pre_hm=None):
        ...
        outputs = [y.shape for y in x]
        # print("Length of base outputs: " + str(len(outputs)))
        # print(outputs)
        # time.sleep(10)
        x = self.dla_up(x)
        outputs = [y.shape for y in x]
        # print("Length of DLA_UP outputs: " + str(len(outputs)))
        # print(outputs)
